...
namespace IntroCSCS
{
    ...
    { // chunk timing helpers
        ...
        public static void TimeSetup(int[] data, int randomSeed, Stopwatch watch)
        {
        ...
        public static void main(string[] args)
        {
            ...
            if (args.Length < 2)
            { ///// can do terminal input /////
                arraySize = UI.PromptInt("Please enter desired array size: ");
                randomSeed = UI.PromptInt("Please enter an initial random seed value: ");
            }
            else
            {
