...
- `1800-graphs.ipynb`: landing page, learning objectives, essential concepts, chapter flow, glossary, slides placeholder
- `1801-graph-vocabulary.ipynb`: vertices, edges, directed and undirected edges, weighted edges, neighbors, degree, paths, model boundaries
- `1802-adjacency-representations.ipynb`: adjacency matrices, weighted matrices, adjacency lists, sparse/dense tradeoffs, small graph class
- `1803-graph-structures-lab.ipynb`: worked graph-representation lab using weighted campus-route data
