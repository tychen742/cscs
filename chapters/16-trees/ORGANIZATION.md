...
2. `1601-tree-structure.ipynb`: Tree vocabulary, recursive structure, traversal orders, height, and leaf-count examples.
3. `1602-binary-search-trees.ipynb`: BST invariant, validation, search, insertion, inorder traversal, shape/performance, and removal preview.
4. `1603-tree-lab.ipynb`: Integrated BST lab for traversal output, search checks, insertion-order comparison, and postorder implementation.
