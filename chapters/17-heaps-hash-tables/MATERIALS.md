...
- `1700-heaps-hash-tables.ipynb` — landing page with overview, objectives, Chapter Flow, video, and glossary
- `1701-priority-queues.ipynb` — priority-queue ADT, C# `PriorityQueue`, heap shape/order rules, bubble-up, and sink-down
- `1702-hashing.ipynb` — hash functions, buckets, collisions, dictionaries, sets, and load factor
- `1703-performance-lab.ipynb` — workload choice, dictionary lookup timing, top-k with a min-heap, and integrated triage example
