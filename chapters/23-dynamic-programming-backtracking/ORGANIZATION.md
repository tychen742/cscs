...
- `2300-dynamic-programming-backtracking.ipynb`: chapter landing page with essential concepts, learning objectives, chapter flow, glossary, and slides placeholder
- `2301-memoization-tabulation.ipynb`: overlapping subproblems, memoization, tabulation, coin-change tables, and choosing a DP style
- `2302-backtracking.ipynb`: choose/explore/undo structure, subset sum, pruning, permutations, and search-space cost
- `2303-optimization-lab.ipynb`: naive recursion, memoization, tabulation, subset-search, and trade-off lab
...
Chapter 23 should teach the shape of dynamic programming and backtracking,
