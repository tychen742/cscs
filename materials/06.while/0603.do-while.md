```{index} statement; do while do while while vs. do while
```
...
the C# language reference [^do-statement]) is:
...
[^do-statement]: See: [C# Language Reference](https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/language-specification/statements#1393-the-do-statement)
