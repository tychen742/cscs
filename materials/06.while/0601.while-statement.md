...
and conditional statements: [^flowchart-while-loop]
...
[^flowchart-while-loop]: The flowchart is from [geeksforgeeks.org](https://www.geeksforgeeks.org/c-while-loop/#)
