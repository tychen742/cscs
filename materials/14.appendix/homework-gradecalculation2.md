```{index} homework; grade calculation 2 grade calculation 2 homework
```
...
2. Also beginning with this assignment, it is expected that your work
   ...
   - proper naming of classes and functions. In C#, the convention is to
     ...
     CamelCase [^cite_camelcase]. We also recommend this same naming convention
   ...
   - This guide from CIS 193 at [^cite_upenncsharp]
...
[^cite_camelcase]: <http://en.wikipedia.org/wiki/CamelCase>

[^cite_upenncsharp]: <http://www.cis.upenn.edu/~cis193/csstyle.html>
