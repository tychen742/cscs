...
This set of lecture notes (this "book") was originally inspired by the work of Andrew N. Harrington and George Thiruvathukal [^footnote-1] , serves as an introductory computer programming textbook at college level.
...
programming language [^f1] [^f2]. Specifically, C# is widely used in areas such as building
...
:alt: Popular programming languages used by professional developers, StackOverflow
:  developer annual survey 2023
:scale: 60%

Popular Programming Languages (StackOverflow Developer Annual Survey 2023 [^f3] )
:::
...
[^footnote-1]: Andrew N. Harrington & George Thiruvathukal. (2021). Introduction to Computer Science in C#. <https://introcs.cs.luc.edu>
