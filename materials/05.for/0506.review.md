...
01. When you have nested `for` loops, and you reach the bottom of the *body* of the
    *inner* loop, where does execution go next?

02. What happens when you omit the condition in a `for` loop?

    Explain and try it out in csharprepl or VS Code and paste the results here.

03. In the heading of a `for` loop, how do you initialize or update
    several variables?
...
06. Distinguish the effects of these two statements:
...
08. What is printed? (Just ",4" has been inserted.)
