...
05. The namespace of this project is *IntroCSCS* but you may use something else such as *IntroCS* as long as
    it is consistent among classes.
06. The class name of this project is *Ch10ClassesLab* if program.cs is used.
07. When executing code, you will *mostly* start with the Main() method in a designated class/file.
08. You will prepare methods in the same class or project *mainly* to be called from the Main() method.
...
1. Complete the simple class Animal in your copy of the file
...
2. Complete the file {repsrc}`test_animal.cs <animal_lab_stub/test_animal.cs>`
