...
[MVC](https://en.wikipedia.org/wiki/Separation_of_concerns) separate presentation and
...
The four basic principles of object-oriented programming are: [^oop-microsoft]
...
To further explain the four pillars of OOP [^oop-techtarget]:
...
[^oop-microsoft]: [Object-Oriented Programming (C#)](https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/tutorials/oop)

[^oop-techtarget]: [Definition: Object-oriented programming (OOP)](<https://www.techtarget.com/searchapparchitecture/definition/object-oriented-programming-OOP#:~:text=Object%2Doriented%20programming%20(OOP)%20is%20a%20computer%20programming%20model,has%20unique%20attributes%20and%20behavior>)
